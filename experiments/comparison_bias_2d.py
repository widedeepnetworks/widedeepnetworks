...
def nn_experiments(X,Y,grid_points):
    ...
    #model.cuda()
    #3000
    pred_mean, pred_var = shared.nn_model_regression(X_var,Y_var,grid_var, model, num_samples = 3000, burn_in = 50, epsilon = 0.05, beta = 1., leap_frog_iters=10 )
...
def main():
    ...
    nn_mean, nn_var = nn_experiments(X,Y,grid_points)
